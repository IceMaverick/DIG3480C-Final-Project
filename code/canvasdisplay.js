...
function CanvasDisplay(parent, level) {
  ...
  this.canvas.width = Math.min(660, level.width * scale);
  this.canvas.height = Math.min(440, level.height * scale);
...
CanvasDisplay.prototype.clearDisplay = function() {
  if (this.level.status == "won")
    ...
    this.cx.drawImage(backgroundSprite, 0, 0);
...
CanvasDisplay.prototype.drawBackground = function() {
  ...
  this.cx.drawImage(backgroundSprite, 0, 0, this.canvas.width, this.canvas.height);
